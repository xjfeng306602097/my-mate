...
const schemaPaths = [
  ...
  path.join(SCHEMAS_ROOT, "agent", "agent-binding-snapshot.schema.json"),
  path.join(SCHEMAS_ROOT, "agent", "agent-run.schema.json"),
  path.join(SCHEMAS_ROOT, "orchestration", "orchestration-decision.schema.json"),
  path.join(SCHEMAS_ROOT, "orchestration", "dag-definition.schema.json"),
  path.join(SCHEMAS_ROOT, "orchestration", "agent-task.schema.json"),
  path.join(SCHEMAS_ROOT, "orchestration", "agent-dag.schema.json"),
  path.join(SCHEMAS_ROOT, "conversation", "session.schema.json"),
  path.join(SCHEMAS_ROOT, "conversation", "task-checkpoint.schema.json"),
  path.join(SCHEMAS_ROOT, "workflow", "workflow-edge.schema.json"),
  path.join(SCHEMAS_ROOT, "workflow", "workflow-node.schema.json"),
  path.join(SCHEMAS_ROOT, "evaluation", "scorecard-policy.schema.json"),
  path.join(SCHEMAS_ROOT, "workflow", "workflow-template.schema.json"),
  path.join(SCHEMAS_ROOT, "workflow", "run-plan.schema.json"),
  path.join(SCHEMAS_ROOT, "workflow", "run-route.schema.json"),
  ...
  path.join(SCHEMAS_ROOT, "evaluation", "evaluation-result.schema.json"),
  path.join(SCHEMAS_ROOT, "evaluation", "replay-result.schema.json"),
  path.join(SCHEMAS_ROOT, "evaluation", "replay-plan-result.schema.json"),
];
