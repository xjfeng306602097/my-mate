...
const smokeMarkers = [
  ...
  ["provider connection reference inspection", appSource, "loadProviderConnectionReferences"],
  ["provider connection binding migration", appSource, "migrateProviderConnectionReferences"],
  ["provider migration target readiness", appSource, 'connection.verification?.status === "verified"'],
  ["provider connection permanent deletion", appSource, "deleteProviderConnectionPermanently"],
  ["provider connection removal review", appSource, 'data-action="inspect-provider-connection-references"'],
  ["provider connection deletion confirmation", appSource, 'data-action="confirm-delete-provider-connection"'],
  ["provider connection removal panel", styleSource, ".provider-removal-panel"],
